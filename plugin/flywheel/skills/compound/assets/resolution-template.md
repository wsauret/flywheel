...
component: [model|controller|view|service|background_job|database|frontend|api|authentication|payments]
symptoms:
  - [Observable symptom 1 - specific error message or behavior]
  - [Observable symptom 2 - what user actually saw/experienced]
root_cause: [missing_association|missing_eager_load|missing_index|wrong_api|scope_issue|thread_violation|async_timing|memory_leak|config_error|logic_error|test_isolation|missing_validation|missing_permission]
framework_version: [18.0.0 - optional]
...
- Framework Version: [e.g., 18.0.0]
- Affected Component: [e.g., "User model", "API service", "Authentication controller"]
