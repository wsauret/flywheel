...
### 7. **Optional: Specialized Agent Invocation** (Post-Documentation)
   ...
   - Any code-heavy issue → `code-simplicity-reviewer` + `architecture-strategist`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ architecture-strategist: Code examples follow best practices
...
### Code Quality & Review
- **architecture-strategist**: Reviews code examples for best practices
