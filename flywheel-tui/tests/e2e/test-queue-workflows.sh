...
const events: FlywheelEvent[] = [
  ...
  { type: "subprocess:spawned", workflowId: "t1", stepIndex: 0, pid: 1234 },
  { type: "subprocess:output", workflowId: "t1", stepIndex: 0, data: "Working on plan...\n", stream: "stdout" },
  { type: "subprocess:completed", workflowId: "t1", stepIndex: 0, exitCode: 0, durationMs: 5000, tokenUsage: undefined },
  ...
  { type: "subprocess:spawned", workflowId: "t1", stepIndex: 1, pid: 1235 },
  { type: "subprocess:completed", workflowId: "t1", stepIndex: 1, exitCode: 0, durationMs: 3000, tokenUsage: undefined },
