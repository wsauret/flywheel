...
echo "  /fly:brainstorm  - Explore ideas conversationally"
echo "  /fly:plan        - Create implementation plans"
echo "  /fly:work        - Execute plans"
echo "  /fly:review      - Multi-agent code review"
echo "  /fly:compound    - Document solved problems"
echo ""
echo "Get started with: /fly:brainstorm your feature idea"
echo ""
