...
1. **Code Review (`/fly:review`)**: If NOT already on the PR branch, offer worktree for isolated review
2. **Feature Work (`/fly:work`)**: Always ask if user wants parallel worktree or live branch work
...
The skill is automatically called from `/fly:review` and `/fly:work` commands:
